...
class CustomVerifyEmail extends VerifyEmailBase
{
    ...
    public function toMail($notifiable): MailMessage
    {
        ...
        return (new MailMessage)
            ->subject('🎫 Verify Your MyGuichet Account')
            ->greeting('Welcome to MyGuichet!')
            ->line('Thank you for registering with MyGuichet! We\'re excited to have you join our community of event enthusiasts.')
            ...
            ->line('If you did not create an account with MyGuichet, no further action is required.')

            ...
            <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 text-gray-900 dark:text-gray-100">
                        ...
                        <!-- Ticket Information -->
                        <div
                            class="bg-gradient-to-r from-blue-50 to-purple-50 dark:from-blue-900 dark:to-purple-900 rounded-lg p-6 mb-8">
                            <div class="flex items-start space-x-4">
                                @if ($ticket->event->image_path)
                                    <img src="{{ Storage::url($ticket->event->image_path) }}"
                                        alt="{{ $ticket->event->title }}" class="w-24 h-24 object-cover rounded-lg">
                                @else
                                    <div
                                        class="w-24 h-24 bg-gradient-to-br from-blue-500 to-purple-600 rounded-lg flex items-center justify-center">
                                ...
                                <div class="flex-1">
                                    ...
                                    <div class="space-y-1 text-gray-600 dark:text-gray-300">
                                        ...
                                        <p>🎟️ Ticket Code: <span
                                                class="font-mono font-bold text-blue-600">{{ $ticket->ticket_code }}</span>
                                        </p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-6 mb-8">
                            ...
                            <div class="space-y-2">
                                <div class="flex justify-between">
                                    <span class="text-gray-600 dark:text-gray-300">Tickets
                                        ({{ $ticket->quantity }}x):</span>
                                ...
                                <div class="flex justify-between text-lg font-bold">
                                    ...
                                    <span
                                        class="text-green-600">${{ number_format($ticket->total_price * 1.15, 2) }}</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="bg-blue-50 dark:bg-blue-900 rounded-lg p-6 mb-8">
                            ...
                            <div class="space-y-3 text-blue-800 dark:text-blue-200">
                                <div class="flex items-start space-x-3">
                                    <span
                                        class="flex-shrink-0 w-6 h-6 bg-blue-600 text-white rounded-full flex items-center justify-center text-sm font-bold">1</span>
                                    <p>Check your email for ticket confirmation and QR codes</p>
                                </div>
                                <div class="flex items-start space-x-3">
                                    <span
                                        class="flex-shrink-0 w-6 h-6 bg-blue-600 text-white rounded-full flex items-center justify-center text-sm font-bold">2</span>
                                    <p>Save your ticket code: <span
                                            class="font-mono font-bold">{{ $ticket->ticket_code }}</span></p>
                                </div>
                                <div class="flex items-start space-x-3">
                                    <span
                                        class="flex-shrink-0 w-6 h-6 bg-blue-600 text-white rounded-full flex items-center justify-center text-sm font-bold">3</span>
